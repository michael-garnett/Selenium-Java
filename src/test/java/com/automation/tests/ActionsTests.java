...
public class ActionsTests extends BasePage {

	@Test
	public void testing_mouse_hoverover() throws Exception {
		driver.get("https://www.usps.com/");
		/*
		 * WebElement mailShipMenu = driver.findElement(By.
		 * cssSelector("#global-menu > div > nav > ol > li.menu--tier-one-category--mail-ship > a"
		 * )); System.out.println("txt: " + mailShipMenu.getText());
		 * 
		 * myLib.moveMouseToElement(mailShipMenu); WebElement subMenu =
		 * driver.findElement(By.partialLinkText("Look Up a ZIP Code"));
		 * subMenu.click();
		 */

		/*
		 * Actions action = new Actions(driver);
		 * action.moveToElement(mailShipMenu).perform(); //action.build().perform();
		 * myLib.customWait(1); WebElement subMenu =
		 * driver.findElement(By.partialLinkText("Look Up a ZIP Code"));
		 * System.out.println("txt: " + subMenu.getText());
		 * action.moveToElement(subMenu).perform(); myLib.customWait(1);
		 */
	...
	public void openBrowser() {
		...
		for (String singleWindow : windows) {
			...
			System.out.println(
					"Browser: " + incrementor + ", Window Handle: " + singleWindow + ", title: " + driver.getTitle());
			incrementor++;
		}
